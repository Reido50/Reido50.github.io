      ...
      <div className={styles.app}>
        ...
        <Routes>
          ...
          <Route path="/portfolio" element={<ProjectPage
            ...
            "I'm very pleased with how it turned out and I learned a ton! It was so rewarding to design the pieces, develop and position them, and see the project come together so quickly."]}/>}></Route>
          ...
          <Route path="/factory-reset" element={<ProjectPage
            ...
            "Finishing Factory Reset and presenting it was easily one of my highlights from my time at MSU. I was so proud of what the team was able to put together over the course of a very busy semester. Out of all 5 teams in the class, we won the Excellence in Design Award from our professors which was the icing on the cake of this extremely challenging, but rewarding project."]}/>}></Route>
        </Routes>
        <Contact/>
      </div>
    </Router>
