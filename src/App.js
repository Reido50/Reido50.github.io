      ...
      <div className={styles.app}>
        ...
        <Routes>
          ...
          <Route path="/portfolio" element={<ProjectPage
            ...
            "This portfolio website is built using React and NodeJS and it's hosted through Github Pages. I was keenly focused on making as much of its components as reusable and generic as I could while still making my design elements feel unique and varied. Another priority was simplicity and scalability since I'll be updating this often with new personal and professional projects. Lastly I wanted to practice at implementing responsive, reactive effects because I find them incredibly satisfying to iterate on and they breathe a lot of life into even the most basic templating.", 
          ...
          <Route path="/diablo-4" element={<ProjectPage
            ...
            duration="7+ Years"
            teamSize="~525"
            description={["Almost 2 years ago, I joined Blizzard Entertainment's Team 3 and had the pleasure to contribute to one of the largest video game franchises of all time. Back when I started, the game wasn't out yet and we were all focused on getting our content into a ship-ready state. It was incredible seeing the whole team rally around polishing up everything we could before the upcoming launch on June 6th, 2023. Diablo IV released to critical acclaim and astronomical player numbers.", 
            "After launch, I joined a smaller subteam on D4 called the Seasons team focused on creating new, exciting, experimental content drops for our dedicated playerbase. Through this, I was able to be heavily involved with concepting, prototyping, iterating, and polishing brand new types of Dungeons for players to fight their way through. I found myself to thrive in this shorter timeline and highly collaborative environment. Not only was this extremely gratifying, but it required me to develop exploit-proof and performant systems and mechanics that could survive the stress of hundreds of thousands of players. Thus far, I've been involved in contributing to Season of the Malignant and Season of the Construct. Both had relatively smooth launches thanks to our diligent weeks of bug fixing and a handful of hotfixes/patches post-launch.",
            ...
            "I'm exceedingly proud of the work I've done on Diablo IV. From my early days eagerly learning the proprietary tools to nowadays confidently creating never-before-seen content, it's shocking to see how much I've grown in just a few years."]}
          ...
          <Route path="/factory-reset" element={<ProjectPage
            ...
            duration="5 Months"
            teamSize="11"
            description={["Factory Reset is a tactical, robot-building roguelite game made in Unity as a capstone project for MSU's Game Design Minor. I served as the team's Producer, Lead Designer, and Effect Engineer. This was one of my first leadership positions on a medium-sized team and it provided me with valuable experience in sprint planning, scoping, and people management. Additionally, throughout development we met weekly with a team of professional game developers who acted as our clients and advisors.", 
            "As you can see from the screenshots, Factory Reset is quite a complicated game with lots of room for strategy and build planning. Because of the high level of complexity of its systems, we had to really hone in the player onboarding experience. Our biggest priority was displaying important information when the player needed it and balancing that with not overwhelming them. We developed a robust tooltip system for all the items in the game as well as made sure all available actions for the player were as responsive as possible. Eventually, with months of iteration and playtesting, new players started to ask less questions and were naturally taking on the intricate enemy encounters with ease. By the end of the project, we had an extremely juicy, responsive, and most importantly fun gameplay experience.", 
